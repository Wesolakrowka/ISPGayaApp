...
class DegreesPage extends StatelessWidget {
  ...
  const DegreesPage({super.key, required this.title});
                  ...
                  children: [
                    ...
                    _buildMenuButton(context, 'Notifications', () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Payment(title: 'Notifications'),
                        ),
                      );
                    }),
                    _buildMenuButton(context, 'Schedules', () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Schedule(title: 'Schedules'),
                        ),
                      );
                    }),
                    _buildMenuButton(context, 'Personal data', () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Personal(title: 'Personal data'),
                        ),
                      );
                    }),
                  ],
