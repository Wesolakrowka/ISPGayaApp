                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        _buildMenuButton(context, label: 'Personal Data', route: const PersonalData()),
                        const SizedBox(height: 20),

                        _buildMenuButton(context, label: 'Messages', route: const ContactsView()),
                        const SizedBox(height: 20),
