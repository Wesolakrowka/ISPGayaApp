...
import 'package:applicationispgaya/viewAdmin/admin_class_management.dart';
import 'package:applicationispgaya/viewStudent/schedule.dart';
import 'package:applicationispgaya/viewAdmin/admin_user_edit.dart';
import 'package:applicationispgaya/viewAdmin/admin_degrees.dart';
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        _buildMenuButton(context, label: 'Class Management', route: AdminClassManagement()),
                        const SizedBox(height: 20),

                        _buildMenuButton(context, label: 'Messages', route: ContactsView()),
                        const SizedBox(height: 20),

                        _buildMenuButton(context, label: 'Manage Users', route: AdminUserEdit()),
                        const SizedBox(height: 20),

                        _buildMenuButton(context, label: 'Manage Degrees', route: AdminDegrees()),
                        const SizedBox(height: 20),
